...
st.set_page_config(page_title="Correlation Analysis", layout="wide", page_icon="📈", initial_sidebar_state="expanded",
                   menu_items={
...
if st.session_state.selected_chart == "Yearly":
    ...
    st.write("<h3>Quarterly Data</h3>", unsafe_allow_html=True)
    ...
    st.write("<h3>Half-yearly Data</h3>", unsafe_allow_html=True)
